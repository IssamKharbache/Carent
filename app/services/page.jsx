    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2  w-full gap-8 mb-12 mt-24 ">
        {services.map((service, i) => (
          <div
            key={i}
            className="flex flex-col mx-auto items-center justify-center max-w-[550px] bg-main/50 shadow-lg py-4 px-12 rounded-lg "
          >
      ...
      <Button className="flex  justify-center items-center mx-auto mb-12 font-semibold px-12 py-6 bg-main hover:bg-main/70">
        Contact us for more
      </Button>
    </motion.div>
  );
